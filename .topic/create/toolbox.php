        ...
        <ol style="padding-left: 10px;">
            ...
            if(isset($data)){
                ...
                foreach($data["toolbox"] as &$item){
                    ...
                    <button id="toolbox_link_'.$index.'" data-id="'.$index.'" class="btn btn-icon toolbox_link store_link_btn existed_item" style="border: 1px solid grey; border-radius: 5px; margin-left: 4px;" ';
